...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="{{ asset('icono.svg') }}">
    <title>Laravel</title>
...
<body class="antialiased font-sans">
    ...
    @livewire('DashboardComponents.Nav.Navbar')
    {{--
    @livewire('PrincipalIcon', ['width' => 5, 'height' => '50px', 'color' => 'red'], key('icon1'))
    @livewire('PrincipalIcon', ['width' => '20px', 'height' => '50px', 'color' => 'green'], key('icon2'))
    @livewire('IconLucide.Iconlucide', ['width' => '24px', 'height' => '24px', 'color' => 'red'])
    --}}



    <!-- Formulario o contenido de la página -->

    <div class="container-xxl bd-gutter mt-3 my-md-4 bd-layout " id="my_content">
        @if (count($errors->all()) > 0)
        <div class="alert alert-danger buscarpa">
    ...
    @endif
        @livewire('DashboardComponents.Contenido.Contenido')
    </div>
